...
function help() {
	return print(
		'Welcome to Arcadia',
		"This terminal serves as your trusted source for real yield.",
		"The bookmarks are 'commands' that you can type in the terminal.",
		"Type 'ls' to see all the commands and explore the ecosystem.",
